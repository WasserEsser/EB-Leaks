...
namespace EloBuddy.Loader.Update
{
    public static class LoaderUpdate
    {
        ...
        public static void UpdateSystem(string data = null)
        {
            IsRunning = true;
            ...
            if (!string.IsNullOrEmpty(data))
            {
                ...
                args["updateDataJson"] = data;
            }

            updateWindow.RunRoutines(
                new UpdateWindow.UpdateWindowDelegate[]
                {
                    LoaderUpdateRoutines.InitializeUpdateRoutine, LoaderUpdateRoutines.LoaderUpdateRoutine, LoaderUpdateRoutines.SystemFilesUpdateRoutine,
                    LoaderUpdateRoutines.PatchFilesUpdateRoutine, LoaderUpdateRoutines.InstallFilesRoutine
                }, args);
